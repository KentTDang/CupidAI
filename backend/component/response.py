...
class eresponse():
    def __init__(self):
        ...
        self.PLAN_PROMPT = ("""You are an expert disaster response planner tasked with creating a comprehensive \
                            ...
                            """)
        self.RESPONDER_PROMPT = ("""You are a disaster response assistant tasked with executing a comprehensive disaster response plan. \
...
# @app.route("/api/disaster-response", methods=['POST', 'GET'])
